...
/**
 * Île client du formulaire d'avis. Reçoit order_id / product_id / email en PROPS
 * (lus côté serveur depuis searchParams) — plus de useSearchParams, donc plus de
 * bascule CSR + Suspense. Le titre/intro sont rendus en SSR par la page parente :
 * même si cette île ne s'hydrate pas, la cliente voit déjà l'en-tête M!LK.
 */
export default function AvisForm({
  ...
  if (error) {
    return (
      <div style={{ padding: "32px 24px", textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: 22, fontWeight: 950, color: C.dark, marginBottom: 12 }}>Lien invalide</h2>
  ...
  if (done) {
    return (
      <div style={{ padding: "32px 24px", textAlign: "center" }}>
        <div style={{ fontSize: 48, marginBottom: 16 }}>⭐</div>
        <h2 style={{ fontSize: 24, fontWeight: 950, color: C.dark, marginBottom: 12 }}>Merci pour ton avis !</h2>
