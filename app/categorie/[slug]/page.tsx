...
const CATEGORY_META: Record<string, { title: string; subtitle: string; seoTitle: string; seoDesc: string }> = {
  ...
  pyjamas: {
    ...
    seoDesc:  "Pyjamas nourrisson en bambou certifié OEKO-TEX. Fermeture zip, thermorégulateur, ultra-doux pour peaux sensibles. Tailles 0-3 mois et 3-6 mois.",
  },
  gigoteuses: {
    ...
    seoDesc:  "Gigoteuses et turbulettes nourrisson en bambou certifié OEKO-TEX. Thermorégulateur, sécurisé, ultra-doux. Tailles Nouveau-né, 0-3 mois, 3-6 mois.",
  },
  accessoires: {
    ...
    seoDesc:  "Accessoires nourrisson en bambou certifié OEKO-TEX. Langes, bavoirs, bonnets et plus encore pour compléter la layette de bébé.",
  },
};
