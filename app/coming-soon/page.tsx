  ...
  return (
    <>
      <style>{`
        ...
        input::placeholder { color: rgba(26,20,16,0.3); }
        input:focus { border-color: rgba(26,20,16,0.5) !important; outline: none; }
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            lineHeight: 1,
            fontFamily: "Boldin, Arial Black, sans-serif",
            animation: "mlk-letter-in 0.3s ease 0.07s both",
          }}>LK</span>
        </div>
        ...
        {!done ? (
          ...
          <p style={{
            ...
            ✓ &nbsp; On te prévient dès l'ouverture.
          </p>
        )}
