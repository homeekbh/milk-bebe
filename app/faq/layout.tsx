...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Quels sont les délais de livraison M!LK ?", acceptedAnswer: { "@type": "Answer", text: "Commandes passées avant 16h : expédition le jour même (jours ouvrés). Colissimo 2-3 jours, Chronopost J+1." } },
    { "@type": "Question", name: "La livraison est-elle gratuite ?", acceptedAnswer: { "@type": "Answer", text: "Oui, livraison offerte dès 60€ d'achat." } },
    { "@type": "Question", name: "Puis-je retourner un article M!LK ?", acceptedAnswer: { "@type": "Answer", text: "Oui. Retour gratuit sous 15 jours après réception. L'article doit être non porté, dans son état d'origine." } },
