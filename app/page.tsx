        ...
        <Reveal>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 28, flexWrap: "wrap", gap: 12 }}>
            <div>
              ...
              <h2 style={{ margin: 0, fontSize: "clamp(22px,3vw,36px)", fontWeight: 950, letterSpacing: -1.5, color: C.dark, lineHeight: 1 }}>{sectionLabel}</h2>
            </div>
      ...
      <div style={{ background: C.light }}>
        <div style={{ padding: "56px 5vw 32px" }}>
          <Reveal>
            ...
            <p style={{ margin: 0, fontSize: "clamp(13px,1.4vw,17px)", color: "rgba(26,20,16,0.65)", lineHeight: 1.75 }}>
        ...
        <Reveal>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
            <div>
              ...
              <h2 style={{ margin: "0 0 16px", fontSize: "clamp(24px,3.5vw,42px)", fontWeight: 950, letterSpacing: -1.5, color: C.dark, lineHeight: 1.05 }}>
          ...
          <div>
            <div style={{ borderRadius: 14, overflow: "hidden", border: `1px solid rgba(196,154,74,0.12)`, marginBottom: 20, boxShadow: "0 6px 20px rgba(0,0,0,0.3)", transform: "translateY(-2px)" }}>
              <div className="comptable" style={{ display: "grid", background: C.bg }}>
                ...
                <div style={{ padding: "12px 16px", fontSize: 11, fontWeight: 900, color: C.amber, textTransform: "uppercase", letterSpacing: 1, borderLeft: `1px solid ${C.faint}` }}>M!LK</div>
              </div>
              {[
