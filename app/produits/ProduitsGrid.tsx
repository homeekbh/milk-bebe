    ...
    <div style={{ background: "#1a1410", minHeight: "100vh", paddingTop: 100, paddingBottom: 80 }}>
      ...
      <div className="produits-outer" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: 3, textTransform: "uppercase", color: "#c49a4a", marginBottom: 12 }}>Collection M!LK</div>
          <h1 style={{ margin: "0 0 12px", fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 950, letterSpacing: -2, color: "#f2ede6", lineHeight: 1 }}>{title}</h1>
          {subtitle && <p style={{ margin: 0, fontSize: 16, color: "rgba(242,237,230,0.45)", lineHeight: 1.6 }}>{subtitle}</p>}
        </div>
