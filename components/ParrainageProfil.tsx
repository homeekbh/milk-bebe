  ...
  return (
    <div style={{ display: "grid", gap: 20 }}>
      ...
      <div style={{ background: DARK, borderRadius: 20, padding: "28px 24px", textAlign: "center" }}>
        ...
        {/* Barème dynamique (lit parrainage_settings en direct via la route publique) */}
        <div style={{ marginTop: 20 }}>
          <ParrainageBareme variant="dark" />
        </div>
        <div style={{ marginTop: 12, fontSize: 12, color: "rgba(242,237,230,0.45)", lineHeight: 1.6, textAlign: "left" }}>
          Un seul code parrain par commande. Tes récompenses sont cumulables sur une même commande, dans la limite des paliers atteints.
        </div>
      </div>
