...
const KNOWLEDGE = [
  ...
  },
  {
    ...
    answer: "Tu peux entrer ton **code promo** directement dans le panier ??? La réduction s'applique automatiquement. Tu peux recevoir nos offres exclusives en t'inscrivant à la newsletter M!LK depuis le footer.",
  },
  {
...
function getBotResponse(input: string): string {
  ...
  if (q.includes("merci")) {
    return "Avec plaisir ! ?? Si tu as d'autres questions, n'hésite pas. Et si tu veux découvrir notre collection, c'est par ici ?? /produits";
  }
